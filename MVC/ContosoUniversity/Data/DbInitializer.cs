...
namespace ContosoUniversity.Data
{
    public static class DbInitializer
    {
        public static void Initialize(UniversityContext context)
        {
            ...
            // Проверяем наличие студентов (а не курсов!)
            if (context.Students.Any())
            {
                return;   // База уже инициализирована
            }

            // ДОБАВЛЕНИЕ СТУДЕНТОВ - РАСКОММЕНТИРОВАТЬ!
            ...
            context.SaveChanges();
            Console.WriteLine("Добавлены студенты");
            ...
            context.SaveChanges();
            Console.WriteLine("Добавлены курсы");

            // ДОБАВЛЕНИЕ ЗАПИСЕЙ НА КУРСЫ - РАСКОММЕНТИРОВАТЬ!
            ...
            context.SaveChanges();
            Console.WriteLine("Добавлены записи на курсы");
        }
    }
}